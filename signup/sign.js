document.addEventListener("DOMContentLoaded", () => {
  ...
  form.addEventListener("submit", async (e) => {
    ...
    username =
      username.charAt(0).toUpperCase() + username.slice(1).toLowerCase(); // Standardize to 'Dman', 'Rajat', etc.
  ...
  document.querySelectorAll(".social-icon").forEach((icon) => {
    icon.addEventListener("click", (e) => {
      ...
      showMessage(
        `Signing in with ${platform.charAt(0).toUpperCase() + platform.slice(1)}...`,
      );
      setTimeout(() => {
